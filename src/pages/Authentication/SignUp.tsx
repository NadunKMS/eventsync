            ...
            <div className="hidden w-full xl:block xl:w-1/2">
              <div className="py-17.5 px-26 text-center">
                ...
                <p className="2xl:px-20">
                  Join our community and unlock a world of streamlined event planning.
                </p>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="relative z-20 bg-white dark:bg-form-input">
                      ...
                      >
                        ...
                        <option value="agriculture_sciences">Faculty of Agriculture Sciences</option>
                        <option value="applied_sciences">Faculty of Applied Sciences</option>
                        <option value="computing">Faculty of Computing</option>
                        <option value="geomatics">Faculty of Geomatics</option>
                        <option value="graduate_studies">Faculty of Graduate Studies</option>
                        <option value="management_studies">Faculty of Management Studies</option>
